          ...
          <>
            <Card className="organizer-meta-card">
              <p className="organizer-small-muted">
                Ceci est un aperçu de vos concerts qui se sont déroulés ou qui se déouleront selon le filtre suivant:
              </p>
              <p className="organizer-small-muted">
            ...
            <Card title="Classement" className="organizer-ranking-card">
              <TabView>
                <TabPanel header="Top revenus">{renderRankingTable(stats.rankings.topByRevenue)}</TabPanel>
                ...
                >
                  ...
                  <Column
                    ...
                    body={(row: { concertStatus: string }) => (
                      <Tag value={row.concertStatus} severity={statusSeverity(row.concertStatus)} />
                    )}
                  />
                  <Column
                    header="Lieu"
                  ...
                  <Column
                    field="sellThroughRatePct"
                    header="Sell-through"
                    body={(row: { sellThroughRatePct: number }) => formatPercent(row.sellThroughRatePct)}
                  />
                  <Column
                  ...
                  <Column
                    field="grossRevenue"
                    header="CA brut"
                    body={(row: { grossRevenue: number }) => currencyFormatter.format(row.grossRevenue)}
                  />
                </DataTable>
                <Divider />
                <p className="organizer-small-muted">Source: GET /stats/me/concerts</p>
              </Card>
            ) : null}
          </>
        ) : null}
